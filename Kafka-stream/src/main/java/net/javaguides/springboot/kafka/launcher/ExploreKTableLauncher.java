...
@Slf4j
@Component
public class ExploreKTableLauncher {

    @Value("${spring.kafka.streams.words}")
    ...
    public void exploreKTableLauncher()  {
        ...
        properties.put(StreamsConfig.APPLICATION_ID_CONFIG,this.wordsId);
        properties.put(StreamsConfig.BOOTSTRAP_SERVERS_CONFIG,this.bootstrapServers);
        properties.put(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG,"latest");

        KafkaStreams streams = new KafkaStreams(ExploreKTableTopology.buildTopology(),properties);
