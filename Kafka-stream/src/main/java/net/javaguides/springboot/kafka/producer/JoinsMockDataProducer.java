package net.javaguides.springboot.kafka.producer;

import lombok.extern.slf4j.Slf4j;

import java.util.Map;

import static net.javaguides.springboot.kafka.producer.ProducerUtil.publishMessageSync;
import static net.javaguides.springboot.kafka.topology.ExploreJoinsOperatorsToplogy.ALPHABETS;
import static net.javaguides.springboot.kafka.topology.ExploreJoinsOperatorsToplogy.ALPHABETS_ABBREVATIONS;
